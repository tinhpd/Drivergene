...
public class AboutTask extends AbstractTask {
	...
	public AboutTask() {
		...
		authorName = new JLabel("Pham Duc Tinh");
		authorName.setBounds(50, 165, 250, 30);
		authorName.setFont(new Font("Tahoma", 1, 13));
		frame.add(authorName);

		authorEmail = new JLabel("Email: tinhpd@haui.edu.vn");
		authorEmail.setBounds(50, 185, 250, 30);
		...
		Image img = new ImageIcon(getClass().getResource("/images/logo_haui.jpg")).getImage();
		ImageIcon icon = new ImageIcon(img);
		authorAvatar.setIcon(icon);
