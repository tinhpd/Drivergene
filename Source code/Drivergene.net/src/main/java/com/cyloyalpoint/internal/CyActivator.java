...
public class CyActivator extends AbstractCyActivator {
	...
	public CyActivator() {
		super();
		LOGGER.info("Creating Drivergene.net bundle activator...");
	}

	@SuppressWarnings("unchecked")
	@Override
	public void start(BundleContext context) throws Exception {
		LOGGER.info("Starting Drivergene.net app...");
		...
		service.submit(() -> {
			...
			LoyalPointPanelAction loyalPointPanelAction = new LoyalPointPanelAction(cyServices,
					ServiceProperties.APPS_MENU + CyModel.MENU_NAME, "1) Compute Total Support");
